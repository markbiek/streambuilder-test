 ...
 */
class EarthquakeStreamCursor extends StreamCursor {
    ...
    protected function _can_combine_with( StreamCursor $other ): bool {
        return $other instanceof EarthquakeStreamCursor;
    }

    // phpcs:ignore
    protected function _combine_with( StreamCursor $other ): StreamCursor {
        /** @var EarthquakeStreamCursor $other */
